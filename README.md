...
- [Build](#build)
- [Usage](#usage)
  - [Manual Control from the Terminal](#manual-control-from-the-terminal)
...
### Manual Control from the Terminal
...
IO25  <-  1. O/P  Analog 0…3.3V  Channel _Top Strip_ L1 (_0 IR Top_)
IO26  <-  4. O/P  Analog 0…3.3V  Channel _Bottom Strip_ L3U (_3 Fluo Btm_)
**O/P  Digital Trigger Pulse OFF is performed from GPIO:**
IO16 (might be updated to IO32)  <- 5. O/P  Digital Trigger Pulse OFF:  0V  Pulse ON:  3.3V  Channel _Top Strip_ L1 (_0 IR Top_)
IO17 (might be updated to IO27)  <- 8. O/P  Digital Trigger Pulse OFF:  0V  Pulse ON:  3.3V  Channel _Bottom Strip_ L3U (_3 Fluo Btm_)
<!-- ?IO32/IO27  L2U (Blue lights) -->
**I/P  Analog 0…3.3V:**
IO34 (VDET_1 = ADC1_6 = Arduino's ADC0)  <- 9. I/P  Analog 0…3.3V  FB Photo diode Channel _Top Strip_ L1 (_0 IR Top_)
IO35 (VDET_2 = ADC1_7 = Arduino's ADC1)  <- 12. I/P  Analog 0…3.3V  FB Photo diode Channel _Bottom Strip_ L3U (_3 Fluo Btm_)
...
**2 internal DACs (IO25, IO26) for Analog O/P:**
IO25  <-  2. O/P  Analog 0…3.3V  Channel _Middle Strip L2S_ (_1 IR Side_)
IO26  <-  3. O/P  Analog 0…3.3V  Channel _Middle Strip L3S_ (_2 Fluo Side_)
**O/P  Digital Trigger Pulse OFF is performed from GPIO:**
IO16 (updating to IO32)  <- 6. O/P  Digital Trigger Pulse OFF:  0V  Pulse ON:  3.3V  Channel _Middle Strip L2S_ (_1 IR Side_)
IO17 (updating to IO27)  <- 7. O/P  Digital Trigger Pulse OFF:  0V  Pulse ON:  3.3V  Channel _Middle Strip L3S_ (_2 Fluo Side_)
**I/P  Analog 0…3.3V:**
IO34 (VDET_1 = ADC1_6 = Arduino's ADC0)  <- 10. I/P  Analog 0…3.3V  FB Photo diode Channel _Middle Strip L2S_ (_1 IR Side_)
IO35 (VDET_2 = ADC1_7 = Arduino's ADC1)  <- 11. I/P  Analog 0…3.3V  FB Photo diode Channel _Middle Strip L3S_ (_2 Fluo Side_)
Alternatively, IO27 (ADC2_7) can be used to read data from 2 distinct ADCs in parallel (ADC1_6 and ADC2_7 ). However, it will load CPU because only ADC1 supports DMA.
